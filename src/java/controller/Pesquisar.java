...
public class Pesquisar extends Base {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (this.request != null && this.request.getParameterMap().containsKey("command") && !this.request.getParameter("command").isEmpty()) {
            try {
...
//        lista produção acadêmica ordenada de forma decrescente de data(ano)
    }
}
