...
<html>
    ...
    <body class="blurBg-false" style="background-color:#EBEBEB">
        ...
        <form action="ControllerColaborador?cmd=incluirProfessor"  class="formoid-metro-cyan" style="background-color:#FFFFFF;font-size:14px;font-family:'Trebuchet MS',Helvetica,sans-serif;color:#666666;max-width:800px;min-width:150px" method="post"><div class="title"><h2>Incluir professor</h2></div>
            ...
            <input type="hidden" name="cmd" value="incluirProfessor">
        </form>
